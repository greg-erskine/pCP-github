...
if [ ${SKIP_INSITU} -eq 0 ]; then
	...
	pcp_txt_cp ${BUILDROOT}/git/picoreplayer-picoreplayer/pcp/mmcblk0p2/tce/bootfix/bootfix.sh $PART2/tce/bootfix/bootfix.sh tc.staff 775
