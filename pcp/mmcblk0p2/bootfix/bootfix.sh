...
# Mark with Version for the update, incase we accidentally include it in an update package when not needed for that version
if [ "$PIVERS" = "piCorePlayer 2.05" ]; then 
	#--------------------------------------------------------------
