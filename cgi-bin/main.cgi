...
echo '      <input type="submit" value="      Update      " size="300"/></form>'
echo '    </td>'
echo '    <td valign="top">'
...
echo '      <input type="submit" value="   Shutdown    " /></form>'
echo '    </td>'
echo '    <td valign="top">'
...
echo '      <input type="submit" value="  Update pCP " /></form>'
echo '    </td>'
echo '    <td valign="top">'
...
echo '      <input type="submit" value=" Save to USB " /></form>'
echo '    </td>'
echo '    <td valign="top">'
