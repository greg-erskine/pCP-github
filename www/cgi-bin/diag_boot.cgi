...
pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /init" 10 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "ls -al /sbin/init" 2 l

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /etc/inittab" 10 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /etc/init.d/rcS" 80 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /etc/init.d/tc-config" 20 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /etc/init.d/dhcp.sh" 4 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /etc/init.d/settime.sh" 4 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /usr/bin/getTime.sh" 4 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /opt/bootsync.sh" 4 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /opt/bootlocal.sh" 4 log
...
pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /home/tc/.profile" 20 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /home/tc/.ashrc" 20 log
...
pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea  "" "cat /etc/init.d/tc-functions" 20 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea  "" "cat /etc/init.d/busybox-aliases" 10 log

pcp_incr_id
echo '    <a id="'$ID'"></a>'
          pcp_textarea "" "cat /proc/cmdline" 30 log
