...
pcp_tweaks_timezone() {
	...
	echo '              <div class="row">'
	echo '                <div class="column150">Timezone</div>'
...
pcp_tweaks_internet_check_ip() {
	...
	if [ $DEBUG -eq 1 ]; then
		...
		echo '                <div class="column210 center">'
...
pcp_tweaks_auto_start() {
	...
	pcp_incr_id
	echo '              <div class="row">'
	echo '                <div class="column150">Auto start favorite</div>'
	echo '                <div class="column420">'
	...
	pcp_incr_id
	echo '              <div class="row">'
	echo '                <div class="column150">Auto start LMS</div>'
	echo '                <div class="column420">'
...
pcp_tweaks_screensize() {
	...
	pcp_incr_id
	echo '              <div class="row">'
	echo '                <div class="column120">'
	echo '                  <button name="ACTION" value="Size">Set Size</button>'
	echo '                </div>'
	echo '                <div class="column120 right">'
	echo '                  <p>Width:&nbsp;</p>'
	echo '                </div>'
	echo '                <div class="column120">'
...
#------------------------------------------------------------------------------------
	if [ "$ALSAeq" = "yes" ]; then
		...
		echo '              <div class="row">'
		echo '                <div class="column150 right">'
...
pcp_tweaks_user_commands() {
	...
	echo '              <div class="row">'
	echo '                <div class="column150">User command #1</div>'
	echo '                <div class="'$COLUMN3_3'">'
	...
	echo '              <div class="row">'
	echo '                <div class="column150">User command #2</div>'
	echo '                <div class="'$COLUMN3_3'">'
	echo '                  <input class="large60"'
	echo '                         type="text"'
	...
	echo '              <div class="row">'
	echo '                <div class="column150">User command #3</div>'
	echo '                <div class="'$COLUMN3_3'">'
	echo '                  <input class="large60"'
	echo '                         type="text"'
