...
pcp_tweaks_rotdash() {
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="rot1" type="radio" name="ROTDASH" value="yes" '$ROTDASHyes'>'
	echo '          <label class="form-check-label" for="rot1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="rot2" type="radio" name="ROTDASH" value="no" '$ROTDASHno'>'
	echo '          <label class="form-check-label" for="rot2">No</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
#	fi
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="wol1" type="radio" name="WOL" value="yes" '$WOLyes'>'
	echo '          <label class="form-check-label" for="wol1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="wol2" type="radio" name="WOL" value="no" '$WOLno'>'
	echo '          <label class="form-check-label" for="wol2">No</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
pcp_tweaks_auto_start() {
	...
	echo '      <div class="col">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="as1" type="radio" name="A_S_FAV" value="Enabled" '$A_S_FAV_Y'>'
	echo '          <label class="form-check-label" for="as1">Enabled</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="as2" type="radio" name="A_S_FAV" value="Disabled" '$A_S_FAV_N'>'
	echo '          <label class="form-check-label" for="as2">Disabled</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	pcp_incr_id
	...
	echo '      <div class="col">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="as3" type="radio" name="A_S_LMS" value="Enabled" '$A_S_LMS_Y'>'
	echo '          <label class="form-check-label" for="as3">Enabled</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="as4" type="radio" name="A_S_LMS" value="Disabled" '$A_S_LMS_N'>'
	echo '          <label class="form-check-label" for="as4">Disabled</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	pcp_incr_id
...
pcp_tweaks_enable_jivelite() {
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="jive1" type="radio" name="JIVELITE" value="yes" '$JIVEyes'>'
	echo '          <label class="form-check-label" for="jive1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
 	echo '          <input class="form-check-input" id="jive2" type="radio" name="JIVELITE" value="no" '$JIVEno'>'
	echo '          <label class="form-check-label" for="jive2">No</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
pcp_tweaks_screenrotate() {
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="scrrot1" type="radio" name="SCREENROTATE" value="0" '$SCREEN0'>'
	echo '          <label class="form-check-label" for="scrrot1">0</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="scrrot2" type="radio" name="SCREENROTATE" value="180" '$SCREEN180'>'
	echo '          <label class="form-check-label" for="scrrot2">180</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
pcp_tweaks_poweroff() {
	...
	echo '      <div class="col-2">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpio1" type="radio" name="GPIOPOWEROFF" value="yes" '$GPIOPOWEROFF_yes'>'
	echo '          <label class="form-check-label" for="gpio1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpio2" type="radio" name="GPIOPOWEROFF" value="no" '$GPIOPOWEROFF_no'>'
	echo '          <label class="form-check-label" for="gpio2">No</label>'
	echo '        </div>'
	echo '      </div>'
	...
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpio3" type="radio" name="GPIOPOWEROFF_HI" value="yes" '$GPIOPOWEROFF_HI_yes'>'
	echo '          <label class="form-check-label" for="gpio3">Active High</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpio4" type="radio" name="GPIOPOWEROFF_HI" value="no" '$GPIOPOWEROFF_HI_no'>'
	echo '          <label class="form-check-label" for="gpio4">Active Low</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#------------------------------------------------------------------------------------
	...
	echo '      <div class="col-2">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd1" type="radio" name="GPIOSHUTDOWN" value="yes" '$GPIOSHUTDOWN_yes'>'
	echo '          <label class="form-check-label" for="gpiosd1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd2" type="radio" name="GPIOSHUTDOWN" value="no" '$GPIOSHUTDOWN_no'>'
	echo '          <label class="form-check-label" for="gpiosd2">No</label>'
	echo '        </div>'
	echo '      </div>'
	echo '      <div class="row col-2">'
	echo '        <div class="col text-right">GPIO:</div>'
	...
	echo '      <div class="col-3">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd3" type="radio" name="GPIOSHUTDOWN_HI" value="yes" '$GPIOSHUTDOWN_HI_yes'>'
	echo '          <label class="form-check-label" for="gpiosd3">Active High</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd4" type="radio" name="GPIOSHUTDOWN_HI" value="no" '$GPIOSHUTDOWN_HI_no'>'
	echo '          <label class="form-check-label" for="gpiosd4">Active Low</label>'
	echo '        </div>'
	echo '      </div>'
	echo '      <div class="col-3">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd5" type="radio" name="GPIOSHUTDOWN_PU" value="up" '$GPIOSHUTDOWN_PU_up'>'
	echo '          <label class="form-check-label" for="gpiosd5">Pull Up</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd6" type="radio" name="GPIOSHUTDOWN_PU" value="down" '$GPIOSHUTDOWN_PU_down'>'
	echo '          <label class="form-check-label" for="gpiosd6">Pull Down</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="gpiosd7" type="radio" name="GPIOSHUTDOWN_PU" value="off" '$GPIOSHUTDOWN_PU_off'>'
	echo '          <label class="form-check-label" for="gpiosd7">Off</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#------------------------------------------------------------------------------------
...
#-------------------------------------------Squeezelite------------------------------
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="squeez1" type="radio" name="SQUEEZELITE" value="yes" '$SQUEEZELITEyes'>'
	echo '          <label class="form-check-label" for="squeez1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="squeez2" type="radio" name="SQUEEZELITE" value="no" '$SQUEEZELITEno'>'
	echo '          <label class="form-check-label" for="squeez2">No</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
#-------------------------------------------Shairport--------------------------------
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="shair1" type="radio" name="SHAIRPORT" value="yes" '$SHAIRPORTyes'>'
	echo '          <label class="form-check-label" for="shair1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="shair2" type="radio" name="SHAIRPORT" value="no" '$SHAIRPORTno'>'
	echo '          <label class="form-check-label" for="shair2">No</label>'
	echo '        </div>'
	echo '      </div>'
...
#-------------------------------------ALSA Equalizer---------------------------------
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="alsaeq1" type="radio" name="ALSAeq" value="yes" '$ALSAeqyes'>'
	echo '          <label class="form-check-label" for="alsaeq1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="alsaeq2" type="radio" name="ALSAeq" value="no" '$ALSAeqno'>'
	echo '          <label class="form-check-label" for="alsaeq2">No</label>'
	echo '        </div>'
	echo '      </div>'
...
#--------------------------------------PCP Streamer----------------------------------
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="streamer1" type="radio" name="STREAMER" value="yes" '$STREAMERyes'>'
	echo '          <label class="form-check-label" for="streamer1">Yes</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="streamer2" type="radio" name="STREAMER" value="no" '$STREAMERno'>'
	echo '          <label class="form-check-label" for="streamer2">No</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
pcp_tweaks_usb_audio_tweaks() {
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="dwc1" type="radio" name="CMD" value="Default" '$CMDdefault'>'
	echo '          <label class="form-check-label" for="dwc1">Default</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="dwc2" type="radio" name="CMD" value="Slow" '$CMDslow'>'
	echo '          <label class="form-check-label" for="dwc2">dwc_otg.speed=1</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
	...
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="fsm1" type="radio" name="FSM" value="Default" '$FSMdefault'>'
	echo '          <label class="form-check-label" for="fsm1">Default</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="fsm2" type="radio" name="FSM" value="Disabled" '$FSMdisabled'>'
	echo '          <label class="form-check-label" for="fsm2">Disable USB-FSM</label>'
	echo '        </div>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="'$COLUMN3_3'">'
...
pcp_tweaks_cron() {
	...
	#-------------------------------------crond indicator--------------------------------
	echo '    <div class="row mx-1">'
	echo '      <div class="col-3 text-md-right">'
	echo '        <p>'$INDICATOR'</p>'
	echo '      </div>'
	pcp_incr_id
	echo '      <div class="col-9">'
	...
	echo '        <div id="dt'$ID'" class="'$COLLAPSE'">'
	echo '          <ul>'
	echo '            <li>'$(pcp_bi_check)' = crond running.</li>'
	echo '            <li>'$(pcp_bi_x)' = crond not running.</li>'
	echo '          </ul>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	...
	echo '      </div>'
	echo '      <div class="form-group col ml-2">'
	...
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="reboot1" type="radio" name="REBOOT" value="Enabled" '$REBOOT_Y'>'
	echo '          <label class="form-check-label" for="reboot1">Enabled</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="reboot2" type="radio" name="REBOOT" value="Disabled" '$REBOOT_N'>'
	echo '          <label class="form-check-label" for="reboot2">Disabled</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#-------------------------------------Squeezelite restart----------------------------
	...
	echo '      <div class="col-4 text-center">'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="restart1" type="radio" name="RESTART" value="Enabled" '$RESTART_Y'>'
	echo '          <label class="form-check-label" for="restart1">Enabled</label>'
	echo '        </div>'
	echo '        <div class="form-check form-check-inline">'
	echo '          <input class="form-check-input" id="restart2" type="radio" name="RESTART" value="Disabled" '$RESTART_N'>'
	echo '          <label class="form-check-label" for="restart2">Disabled</label>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#------------------------------------------------------------------------------------
	...
	echo '          <textarea class="col-12 mb-3">'"$(cat /var/spool/cron/crontabs/root)"'</textarea>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#-------------------------------------Custom Cron command----------------------------
	echo '    <div class="row mx-1">'
	echo '      <div class="col-3">Custom Cron command</div>'
	echo '      <div class="col-9">'
	echo '        <input class="form-control form-control-sm"'
	echo '               type="text"'
	echo '               name="CRON_COMMAND"'
	echo '               value="'$CRON_COMMAND'"'
	echo '               maxlength="254"'
	echo '        >'
	echo '      </div>'
	echo '    </div>'
...
pcp_tweaks_user_commands() {
	...
	echo '          <p>If starting a second instance of Squeezelite - notice that pCP only accepts name without empty space. So change <b>first floor</b> to <b>first_floor</b> etc.</p>'
	echo '        </div>'
	echo '      </div>'
	echo '    </div>'
	#------------------------------------------------------------------------------------
