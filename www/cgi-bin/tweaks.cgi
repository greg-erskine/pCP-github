...
echo '                  <input class="small2" type="text" name="RB_H" value="'$RB_H'" maxlength="2" pattern="^[1-2*]|[0-4]*$" />'
...
echo '                  <input class="small2" type="text" name="RB_DMONTH" value="'$RB_DMONTH'" maxlength="2" pattern="^[1-12*]*$" />'
echo '                </td>'
echo '                <td>'
