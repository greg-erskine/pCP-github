...
echo '              </td>'
echo '              <td>'
echo '                <p>Disable GUI and web server&nbsp;&nbsp;'
echo '                <a class="moreless" id="ID11a" href=# onclick="return more('\''ID11'\'')">more></a></p>'
echo '                <div id="ID11" class="less">'
echo '                  <p>Disabling the web server can be useful in public areas to restrict access to the web GUI.'
echo '                     This prevents users from changing the settings.</p>'
echo '                  <p>If you need access to web GUI later, you will need to re-enable the web server by:</p>'
echo '                  <ul>'
echo '                    <li>Logging in via ssh and at the command prompt type "enablegui"</li>'
echo '                  </ul>'
echo '                </div>'
echo '              </td>'
echo '            </tr>'
