...
pcp_submit_button() {
	...
	echo '        <input class="'$BUTTON'" type="submit" name="SUBMIT" value="Save" title="Save &quot;Squeezelite settings&quot; to configuration file, and restart squeezelite." onclick="return(validate());">'
...
echo '        <select class="" id="audiocard" name="AUDIO">'
...
if [ x"" != x"$CONTROL_PAGE" ]; then
	...
	echo '      <div class="row">'
	echo '        <div class="'$COLUMN2_1'">'
	echo '          <input class="'$BUTTON'" type="button" value="Card Control" onClick="location.href='\'''$CONTROL_PAGE''\''" '$CNTRL_DISABLED'>'
	echo '        </div>'
	echo '        <div class="'$COLUMN2_2'">'
	[ -f $REBOOT_PENDING ] &&
...
pcp_squeezelite_alsa() {
	...
	if [ $DEBUG -eq 1 ]; then
		...
		echo '       </div>'
		echo '       <div class="'$COLUMN3_2'">'
		echo '         <input class="XXXX" type="text" name="ALSA_PARAMS" value="'$ALSA_PARAMS'" readonly>'
		echo '       </div>'
		echo '       <div class="'$COLUMN3_3'">'
		echo '       </div>'
		echo '     </div>'
...
pcp_squeezelite_log_level() {
	...
	echo '      </div>'
	echo '      <div class="'$COLUMN3_2'">'
	echo '        <select class="XXXX" name="LOGLEVEL" title="Log level setting">'
