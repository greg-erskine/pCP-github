...
echo '            </td>'
echo '            <td>'
echo '              <p>Specify the piCorePlayer name&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Specify the output device&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Specify the ALSA params to open output device&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Specify internal Stream and Output buffer sizes in KB&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Restrict codecs to those specified, otherwise load all available codecs&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Set real time priority of output thread&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Sample rates supported, allows output to be off when Squeezelite is started&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Connect to the specified LMS, otherwise autodiscovery will find the server&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Write debug logfile to attached USB stick&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Output device supports DSD over PCM (DoP)&nbsp;&nbsp;'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Visualiser support*&nbsp;&nbsp;'
echo '              <a class="moreless" id="ID14a" href=# onclick="return more('\''ID14'\'')">more></a></p>'
...
echo '            </td>'
echo '            <td class="column210">'
echo '              <input class="large15" type="text" id="CLOSEOUT" name="CLOSEOUT" size="32" value="'$CLOSEOUT'">'
echo '            </td>'
echo '            <td>'
echo '              <p>Set idle time before squeezelite close output&nbsp;&nbsp;'
echo '              <a class="moreless" id="ID15a" href=# onclick="return more('\''ID15'\'')">more></a></p>'
echo '              <div id="ID15" class="less">'
echo '                <p>&lt;timeout&gt&gt;</p>'
echo '                  <li>value in seconds</li>'
...
echo '            </td>'
echo '            <td>'
echo '              <p>Add another command&nbsp;&nbsp;'
echo '              <a class="moreless" id="ID16a" href=# onclick="return more('\''ID16'\'')">more></a></p>'
