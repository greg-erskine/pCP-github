...
echo '                </td>'
echo '                <td class="column210">'
echo '                   <input class="large15" type="text" name="OUTPUT" value="'$OUTPUT'" pattern="^[a-zA-Z0-9:,=]*$" list="outputdevice">'
echo '                   <datalist id="outputdevice">'
echo '                      <option value="equal"> 10 band Equalizer:</option>'
echo '                   </datalist>'
echo '                </td>'
echo '                <td>'
...
echo '                     <p><b>Note: </b>If you select <b>equal</b>, the ALSA equalizer will be used. To adjust the mixer you need to:</p>'
echo '                    <ul>'
echo '                     <li>SHH into piCorePlayer, then sudo alsamixer -D equal and adjust the settings, press escape</li>'
echo '                     <li>To save your settings either do: sudo filetool.sh or use the backup button on the Main webpage of piCorePlayer.</li>'
echo '                    </ul>'
echo '                  </div>'
echo '                </td>'
echo '              </tr>'
